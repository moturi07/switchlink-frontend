        ...
        methods: {            	
            async getPosts() {
                ...
                if(user !=null){                    
                    ...
                    try {
                        let res = await axios({
                            url: "https://moturi-atm.somee.com/api/Accounts/GetAccount/"+user.email+"/",
                            method: "GET",
                        });                        
                ...
                if(user !=null){ 
                    try {
                        let acc_resp =await axios({
                            url: "https://moturi-atm.somee.com/api/Accounts/GetAccountNumber/"+user.email+"/",
                            method: "GET",
                        });                     
                        let accounts = JSON.parse(acc_resp.data);
                        let no=accounts[0].account_number;
                        let trans = await axios({
                            url: "https://moturi-atm.somee.com/api/values/Get/"+no,
                            method: "GET",
                        });
